...
module contracts::vault_tests {
    ...
    fun test_create_shared_vault() {
        ...
        test_utils::next_tx(&mut scenario, creator());
        {
            ...
            let _vault_id = publication_vault::create_vault<MockBlob>(
                batch_size,
        ...
        test_utils::next_tx(&mut scenario, creator());
        {
            ...
            let (renewal_epoch, vault_batch_size) = publication_vault::get_vault_info(&vault);
    ...
    fun test_renewal_system_with_shared_vault() {
        ...
        test_utils::next_tx(&mut scenario, admin());
        {
            ...
            let (renewal_epoch, _) = publication_vault::get_vault_info(&vault);
    ...
    fun test_vault_management_functions() {
        ...
        test_utils::next_tx(&mut scenario, creator());
        {
            ...
            let (renewal_epoch, batch_size) = publication_vault::get_vault_info(&vault);
